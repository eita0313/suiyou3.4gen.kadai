...
if (isset($_POST['body'])) {
    ...
    if (isset($_FILES['image']) && !empty($_FILES['image']['tmp_name'])) {
        // アップロードされたものが画像ではなかった場合処理を強制的に終了 (演習1: MIMEチェック)
    ...
    <dd>
      ...
      <?php if(!empty($entry['image_filename'])): ?>
        <div style="margin-top: 0.5em;">
          <img src="/image/<?= htmlspecialchars($entry['image_filename']) ?>" style="max-width: 300px; height: auto;">
        </div>
      <?php endif; ?>
    </dd>
  </dl>
...
<!-- 演習3: JavaScriptによるファイルサイズ上限（5MB）チェック -->
<script>
